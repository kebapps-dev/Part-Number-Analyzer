function findClosestBlowerMotor() {
  ...
  const staticPressure = getValueWithUnit("blowerPressure");
  const fanEfficiencyPercent = getValueWithUnit("blowerFanEff");
  const motorEfficiencyPercent = getValueWithUnit("blowerMotorEff");
  const rpm = getValueWithUnit("blowerRequiredSpeed");
