function findClosestConveyorMotor() {
  ...
  const rotationalSpeed = conveyorformulas.linearToRotationalSpeed(beltSpeed, rollerDiameter); // rad/s (base)
  ...
  // Convert rad/s -> RPM for display
  "(3) Operating Speed": `${(rotationalSpeed * 60 / (2 * Math.PI)).toFixed(2)} RPM`,
